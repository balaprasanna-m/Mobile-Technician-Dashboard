...
const PATHS: Record<IconName, string> = {
  ...
  orders:
    '<path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><circle cx="3.5" cy="6" r="1.5"/><circle cx="3.5" cy="12" r="1.5"/><circle cx="3.5" cy="18" r="1.5"/>',
  'my-orders':
  ...
  'eye-off':
    '<path d="M9.9 4.2A10.9 10.9 0 0 1 12 4c6.5 0 10 7 10 7a18 18 0 0 1-3.2 4.1M6.6 6.6A18 18 0 0 0 2 11s3.5 7 10 7a10.9 10.9 0 0 0 4.1-.8"/><path d="m4 4 16 16"/><path d="M9.5 9.5a3 3 0 0 0 4.2 4.2"/>',
  ...
  package:
    '<path d="m12 2 9 5v10l-9 5-9-5V7l9-5z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/>',
